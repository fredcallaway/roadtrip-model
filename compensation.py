...
class MechanicalTurk(object):
    def __init__(self, config_dict=None, config_file='mturkconfig.json'):
        ...
        self.aws_access_key_id = mturk_config_dict["aws_access_key_id"]
        self.aws_secret_access_key = str(mturk_config_dict["aws_secret_access_key"])
